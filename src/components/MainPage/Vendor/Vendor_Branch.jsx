 ...
 */
 ...
 VendorBranch();
   ...
   await axios.get(`${API_URL}/vendor/branch/get`).then((res)=>{
 ...
 setvendorBranch(res.data.data);
  ...
  const VendorInfo = async () => {
   ...
   const onSubmit = (data) => {
     console.log(data);
     axios
       .post(`${API_URL}/vendor/branch/add`, data, {
         headers: {
                     ...
                     <div class="modal-body ">
                       <div className="row Product_add">
                         ...
                         <div className="mb-2 row">
                            ...
                            >
                              {" "}
                              <span style={{ color: "red" }}>*</span> Select Vendor
                           ...
                           <div className="mb-2 row">
                             ...
                             <div className="col-sm-8">
                              <textarea rows="3" placeholder="Address"  class="form-control Vendor-form-control"
                              {...register("address", {
                                required: true,
                              })}
                              ></textarea>
                   ...
                   {DataLoader && (
                     <div className="table-responsive vendor_table_box">
                       <Table
                         ...
                         columns={columns}
                         // bordered
                         dataSource={vendorBranch.length > 0 ? vendorBranch : null}
                 ...
                 <div class="modal-dialog modal-lg" role="document">
                   <div class="modal-content">
                     <div class="modal-header">
                       ...
                       >
                         <i className="fa fa-pencil m-r-5" /> Update Vendor Branch
                         {UpdateDataFound.id}
                       </h5>
                       <button
                         type="button"
