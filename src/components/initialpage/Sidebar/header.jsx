...
const Header = ()=>{
  const[cookiesExpiredRedirectToLogin,setcookiesExpiredRedirectToLogin]=useState("");
 ...
 useEffect(()=>{
  setcookiesExpiredRedirectToLogin(cookies.get("name"))
  if(cookiesExpiredRedirectToLogin==undefined){
    localStorage.removeItem("LoginData");
      localStorage.removeItem("access_token");
      Navigate("/vendor/login");
    
      console.log("after"+cookiesExpiredRedirectToLogin)
  }
 },[cookiesExpiredRedirectToLogin])


console.log("before"+cookiesExpiredRedirectToLogin)
                ...
                <ul className="nav user-menu">
                  ...
                  <li className="nav-item dropdown has-arrow main-drop">
                    ...
                    <div className="dropdown-menu">
                      ...
                      <a className="dropdown-item" onClick={()=>Logout()} >Logout00</a>
                    </div>
                  </li>
                </ul>
                {/* /Header Menu */}
